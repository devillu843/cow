...
from Backbone.resne import ALOM_resnet50_two_alone,ALOM_resnet50_two
...
val_data_set = MyDataset2(image_path1=val_images_path1,
                          image_path2=val_images_path2,
                          label=val_images_label1,
                          transform=data_transform["val"])
test_data_set = MyDataset2(image_path1=test_images_path1,
...
if train:
    ...
    for epoch in range(epochs):
        ...
        with torch.no_grad():
            ...
            for _, (val_image1, val_image2, val_labels) in loop_val:
                outputs = model(val_image1.to(device), val_image2.to(device))
...
if test:
    ...
    with torch.no_grad():
        ...
        batch_num = 1
        for _, (test_image1, test_image2, test_labels) in loop_test:
            outputs = model(test_image1.to(device),
                            test_image2.to(device))  # 指认设备
